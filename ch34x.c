 ...
 *
 * USB driver for USB to serial chip ch34x
 *
 * Sponsored by SuSE
 *
 * System required:
...
#define DRIVER_DESC "USB driver for USB to serial chip ch340, ch341, ch9341, etc."
#define VERSION_DESC "V1.11 On 2020.03.02"
...
//	}
	...
	dev_info(&intf->dev, "ttyUSB%d: ch34x USB device\n", minor);
...
static int __init ch34x_init(void)
{
	...
	if (!ch34x_tty_driver)
		return -ENOMEM;
	ch34x_tty_driver->driver_name = "usbch34x",
